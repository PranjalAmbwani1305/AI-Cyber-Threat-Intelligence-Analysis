...
st.write("Upload a **CSV, PDF, or TXT** report to extract cyber entities and visualize threat relationships.")
...
if uploaded_file:
    ...
    if not text.strip():
        ...
        if not results:
            st.warning("No CTI entities found in this document.")
        else:
            ...
            st.subheader("🌐 CTI Knowledge Graph")
            st.pyplot(fig)
